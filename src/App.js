        ...
        <div style={{
          ...
          {['all', 'active', 'done'].map(f => (
            <button
              ...
              style={{
                fontSize: '12px',
                color: filter === f ? '#e8e6f0' : '#8b87a8',
                background: filter === f ? 'rgba(108,92,231,0.3)' : 'rgba(255,255,255,0.06)',
                padding: '6px 16px',
                borderRadius: '6px',
                border: filter === f ? '0.5px solid rgba(108,92,231,0.5)' : '0.5px solid transparent',
                cursor: 'pointer',
            ...
            <div style={{
              ...
              <p style={{ fontSize: '14px', margin: 0 }}>
                {filter === 'all' ? 'No tasks yet. Even cats need a plan!' :
                 ...
                 'Nothing completed yet. Get to work, kitty!'}
              </p>
            </div>
          ) : (
            filteredTasks.map((task, index) => (
              <div
                ...
                style={{
                  ...
                  padding: '14px 18px',
                  borderBottom: index < filteredTasks.length - 1 ? '0.5px solid rgba(255,255,255,0.08)' : 'none',
                  background: task.completed ? 'rgba(108,92,231,0.05)' : 'transparent'
                }}
              >
                <div style={{
                  display: 'flex',
                  ...
                  <span style={{
                    fontSize: '14px',
                    color: task.completed ? '#8b87a8' : '#e8e6f0',
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '4px 12px',
                    borderRadius: '6px',
                    border: '0.5px solid rgba(231,92,92,0.2)',
                    cursor: 'pointer'
                  }}
                >
                  Delete
